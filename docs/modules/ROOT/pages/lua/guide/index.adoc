...
Please don't be scared at first sight. +
...
Before you toss the mod away as too hard or complex, seriously try it first.
...
Most unlockable tech is located in the Tier 3 of the HUB. +
...
even tho these are not unlocked until a later tier. +
This is not a bug, you are supposed to venture out into the world, explore it, and search for crash sites. +
